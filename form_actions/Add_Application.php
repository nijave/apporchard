	...
	<div id="add-form">
		...
		if($formAction->checkParams()) {
			...
			try {
				...
				echo "<p>The following error was encountered while trying to submit your application: ";
				echo $e->getMessage();
				echo "<br>Please fix the error and try submitting your application again.</p>";
				$applicationSuccess = false;
			}
			if($applicationSuccess)
				echo "<p>Your application <strong>{$object->getTitle()}</strong> has been successfully submitted! Note, your application will not appear until it's been approved by a moderator.</p>";
		}
		else {
